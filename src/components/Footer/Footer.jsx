    ...
    <motion.section
        ...
        <motion.div
            ...
            <div className={css.left}>
                ...
                <span className="primaryTextDevelop">
                    <a href="https://github.com/axelclemente?tab=repositories" target="_blank">Axel Clemente</a> <BsGithub className={css.icon} /> <br />
                    <a href="https://github.com/arcadioreyes/" target="_blank">Arcadio Reyes</a> <BsGithub className={css.icon}/>
                </span>
            </div>
